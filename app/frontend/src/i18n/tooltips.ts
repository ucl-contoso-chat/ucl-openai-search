...
export const toolTipText = {
    ...
    hfModel:
        "Selects the Hugging Face model to use for generating responses, to add support of new models, create a template and add the model into list of supported models.",
